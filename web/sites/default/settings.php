 ...
 * @endcode
 */
$settings['hash_salt'] = 'X2OY46b2sAbZOGLoOkqDKOYVa0YYYvb8W33Xq4I-VAL0GVZjgpRPYehNlVgxY1qGAs6ifLJ8_w';
...
if (file_exists(__DIR__ . '/settings.ddev.php') && $_ENV['IS_DDEV_PROJECT'] == 'true') {
  include __DIR__ . '/settings.ddev.php';
}

// Include settings required for Redis cache.
if ((file_exists(__DIR__ . '/settings.ddev.redis.php') && $_ENV['IS_DDEV_PROJECT'] == 'true')) {
  include __DIR__ . '/settings.ddev.redis.php';
}

// Retrieves the environment name and includes the corresponding settings file.
$environment = $_ENV['APP_ENV'];
switch ($environment) {
  case 'local_dev':
    include $app_root . '/' . $site_path . '/settings.local_dev.php';
    break;
